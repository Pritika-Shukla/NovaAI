...
export function FinalCTA() {
  ...
  return (
    <section id="contact" className="pt-16 pb-10 px-4">
      <motion.div
        ref={ref}
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-zinc-400 mb-10 max-w-2xl mx-auto">
          Join thousands of job seekers already practicing with NovaAI. Start free, no credit card required.
        </p>
        ...
        <p className="mt-8 text-sm text-zinc-500">Free practice for individuals. Upgrade for more sessions and advanced feedback.</p>
      </motion.div>
    </section>
  )
}
