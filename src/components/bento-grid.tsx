      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">
            Built for job seekers. AI-powered practice, personalized feedback, and performance insights so you can interview with confidence.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Live AI Interview Practice</h3>
                <p className="text-zinc-400 text-sm">
                  Practice with a voice AI interviewer that asks questions based on your resume. Real-time conversation, no scripts.
                </p>
              </div>
              <SystemStatus />
            </div>
            <div className="grid grid-cols-4 gap-4">
              {["Technical", "Communication", "Depth", "Overall"].map((metric) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Customizable Practice</h3>
            <p className="text-zinc-400 text-sm mb-6">Focus on frontend, backend, fullstack, or technical depth. Practice what matters for your target role.</p>
            <KeyboardCommand />
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">AI-generated feedback, ratings, and recommendations after every practice interview.</p>
            <AnimatedChart />
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">
              Get detailed feedback and an overall rating as soon as your practice interview ends.
            </p>
            <div className="flex items-center gap-2 text-emerald-500 text-sm">
              <span className="font-mono">Minutes</span>
              <span className="text-zinc-500">to feedback</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Your Data, Protected</h3>
            <p className="text-zinc-400 text-sm mb-4">Resume and interview data stored securely. You own your practice history and feedback.</p>
            <div className="flex items-center gap-2">
              <span className="px-2 py-1 text-xs bg-zinc-800 rounded text-zinc-400">Private</span>
              <span className="px-2 py-1 text-xs bg-zinc-800 rounded text-zinc-400">Secure</span>
              <span className="px-2 py-1 text-xs bg-zinc-800 rounded text-zinc-400">Yours</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
